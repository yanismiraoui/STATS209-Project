...
tau_1 <- (1/(n_control_1+n_treatment_1))*((sum(data_covs_1_treatment[,Y_name]) + sum(mu_tilde_1_control)) - (sum(data_covs_1_control[,Y_name]) + sum(mu_tilde_1)))
...
tau_2 <- (1/(n_control_2+n_treatment_2))*((sum(data_covs_2_treatment[,Y_name]) + sum(mu_tilde_2_control)) - (sum(data_covs_2_control[,Y_name]) + sum(mu_tilde_2)))
